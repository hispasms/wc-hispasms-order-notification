...
use hispaSMS\models\DeliveryReportSubscription;
use hispaSMS\models\GenericObject;
use hispaSMS\models\MoSubscriptions;
...
class SmsClient extends AbstractOneApiClient {
    ...
    public static function unserializeDeliveryStatus($json=null) {
        ...
        return Conversions::createFromJSON('hispaSMS\models\DeliveryInfoNotification', $json);
    }
    ...
    public static function unserializeInboundMessages($json=null) {
        ...
        return Conversions::createFromJSON('hispaSMS\models\InboundSmsMessage', $json);
    }
    ...
    public function sendSMS($message) {
        ...
        return $this->createFromJSON('hispaSMS\models\ResourceReference', $content, !$isSuccess);
    }
    ...
    public function queryDeliveryStatus($clientCorrelatorOrResourceReference = null) {
        ...
        return $this->createFromJSON('hispaSMS\models\DeliveryInfoList', $content, !$isSuccess);
    }
    ...
    public function retrieveOutboundMessages($fromTime=null, $toTime=null, $messageId=null){
        ...
        return $this->createFromJSON('hispaSMS\models\OutboxMessages', $content, !$isSuccess);
    ...
    public function retrieveInboundMessages($maxNumberOfMessages=null){
        ...
        return $this->createFromJSON('hispaSMS\models\InboundSmsMessages', $content, !$isSuccess);
    }
    ...
    public function subscribeToDeliveryStatusNotifications($subscribeToDeliveryNotificationsRequest) {
        ...
        return $this->createFromJSON('hispaSMS\models\DeliveryReportSubscription', $content, !$isSuccess);
    }
